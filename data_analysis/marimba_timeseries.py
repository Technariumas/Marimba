...
def play_timeseries(sequence, loudness):
	...
	midi.seq_notes(lightMinSeq, time=0.25, track=CHANNEL_PARAM_LED_MINIMUM)
	midi.seq_notes(lightMaxSeq, time=0.5, track=CHANNEL_PARAM_LED_MAXIMUM)
